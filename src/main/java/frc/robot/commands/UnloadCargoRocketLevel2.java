...
public class UnloadCargoRocketLevel2 extends CommandGroup {
  ...
  public UnloadCargoRocketLevel2() {
    ...
    addParallel(new PositionLift(RobotMap.LIFT_ENCODER_CARGO_ROCKET_LEVEL_2));
    addParallel(new PositionTargetArm(RobotMap.TARGET_ARM_ENCODER_CARGO_ROCKET_LEVEL_2));
  }
}
